/*
 * abi.h — the userspace<->kernel ABI TYPES and CONSTANTS (ARM 32-bit EABI).
 *
 * Companion to syscalls.h (which holds the numbers). This is the rest of the
...
_Static_assert(__builtin_offsetof(struct dirent64, d_name) == 19,
