...
| 44 | 1 | 3.3 V buck-boost | TPS63021DSJR (fixed 3.3 V) | C202140 | SYS → 3.3 V logic | ✅ | JLC | VSON-14-EP, fixed 3.3 V (**C202140**, not C64595). 1S cell straddles 3.3 V → buck-boost mandatory. ~1.9–2.4 A at the 3.0 V floor. **EN = the on/off control point (slide switch #55).** Inductor + output caps MUST be the datasheet Table-1 combo. **Exposed pad → PGND + thermal vias.** |
